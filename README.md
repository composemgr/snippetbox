...
- **snippetbox**: pawelmalak/snippet-box:latest

### Infrastructure Components

- **snippetbox-db**: Mariadb database
...
```bash
curl -q -LSsf "https://raw.githubusercontent.com/composemgr/snippetbox/main/docker-compose.yaml" -o compose.yml
```
